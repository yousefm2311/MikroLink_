...
cron.schedule("*/10 * * * *", async () => {
  try {
    ...
    // هات كل السواقين اللي آخر تحديث لهم أقدم من 10 دقايق
    ...
    console.log(`⏰ تم تحويل ${inactiveDrivers.length} سائق إلى Offline`);
  } catch (err) {
    console.error("❌ خطأ في عملية التحديث التلقائي:", err.message);
  }
});
